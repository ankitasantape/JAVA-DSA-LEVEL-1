...
public class A03_Permutations_2 {
    
	public static void permutations(int cb, int tb, int[] items, int ssf, int ts, String asf) {
		if(cb > tb) {
//			if solutions so far is equal to total solutions then print path
			if(ssf == ts) {
...
//		if item don't want to add itself then spot will be blank as well and blank will added into asf -> answer so far
