...
public class A08_Transform_To_Left_Cloned_Tree {
	public static class Node {
	  ...
	  public static Node createLeftCloneTree(Node node){
	       ...
	       Node clonedNode = new Node(node.data, null, null);
	       clonedNode.left = node.left;
	       node.left = clonedNode;
	       
	       Node leftTree = createLeftCloneTree(clonedNode);
	  ...
	  public static void createLeftCloneTree2(Node node){
	       ...
	       Node clonedNode = new Node(node.data, node.left, null);
	       node.left = clonedNode;      	       
	  }
