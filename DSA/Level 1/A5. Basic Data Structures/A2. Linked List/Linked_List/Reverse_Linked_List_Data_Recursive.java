 ...
 */
public class Reverse_Linked_List_Data_Recursive {
...
//	    left ko heap me rakhna padega
	    Node left;
//	    you can use this login in is_linkedlist_a_palindrome function
		private void reverseDRHelper(Node right, int counter) {
			if (right == null) {
				return;
			}
			reverseDRHelper(right.next, counter+1);
//			below code should be run upto half of the linked list  
			if (counter >= size/2) {
				int temp = left.data;
				left.data = right.data;
				right.data = temp;
