...
public class A29_Remove_Before_In_Doubly_Linked_List {
	...
	public static class DoublyLinkedList {
		...
		public int removeBefore(Node refNode) {
            ...
            Node rnp = refNode.prev; // refNode ka next
			
			if( rnp.prev == null  ) {
				int val = rnp.data;
				refNode.prev = rnp.next = null;
				...
				int val = rnp.data;
				rnp.prev.next = refNode;
				refNode.prev = rnp.prev;
				
				rnp.prev = rnp.next = null;
