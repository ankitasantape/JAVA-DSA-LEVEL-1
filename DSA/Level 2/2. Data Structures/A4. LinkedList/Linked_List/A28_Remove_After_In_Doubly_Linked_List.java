...
public class A28_Remove_After_In_Doubly_Linked_List {
	...
	public static class DoublyLinkedList {
		...
		public int removeAfter(Node refNode) {
            Node rnn = refNode.next; // refNode ka next
			...
			if( rnn.next == null  ) {
				...
				int val = rnn.data;
				refNode.next = rnn.next;
				
				rnn.next.prev = refNode;
				
				rnn.next = rnn.prev = null;
