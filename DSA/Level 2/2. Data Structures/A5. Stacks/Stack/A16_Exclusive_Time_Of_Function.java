...
public class A16_Exclusive_Time_Of_Function {
    ...
    public static  int[] exclusiveTime(int n, List < String > logs) {
        ...
        for (String log: logs) {
            ...
            String action = arr[1];
            int t = Integer.parseInt(arr[2]); // time
            ...
            if (action.equals("start") == true) {
                ...
                if (st.size() > 0) {
                    //parent exists 
                    st.peek().wt += tts; // add child's execution time + waiting time is equal to parent's waiting time
                }
            }
        }
