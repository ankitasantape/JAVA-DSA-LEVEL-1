...
public class A32_AVL {
	...
	public static Node solveLL(Node A) {
		// in order to solve LL problem at A, we need to do right rotation at A's left
		// child
	...
	public static Node solveRR(Node A) {
		// in order to solve RR problem at A, we need to do left rotation at A's right
		// child
