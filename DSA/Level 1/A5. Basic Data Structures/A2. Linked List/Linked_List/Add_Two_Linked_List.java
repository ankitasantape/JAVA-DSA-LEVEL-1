...
import Linked_List.Intersection_Of_Two_Linked_List.Node;
	...
	public static class Node {
	  ...
	  public static class LinkedList {
	    ...
	    public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
	          ...
	          int cy = addTwoListsHelper(temp1, size1, temp2, size2, res);
	          if(cy > 0) {
	        	  res.addFirst(cy);
	          }
	    ...
	    public static int addTwoListsHelper(Node one, int size1, Node two, int size2,LinkedList res) { 
	    	 if (size1 == 0 && size2 == 0) {
	    		  return 0;
	    	 }
	    	 int sum = 0;
	    	 if(size1 > size2) {
	    		 int cy = addTwoListsHelper(one.next, size1 - 1, two, size2, res);
	    		 sum = one.data + cy;
	    		 
	    	 } else if(size1 < size2){
	    		 int cy = addTwoListsHelper(one, size1, two.next, size2 - 1, res);
	    		 sum = two.data + cy;
	    	 } else {
	    		 int cy = addTwoListsHelper(one.next, size1 - 1, two.next, size2 - 1, res);
	    		 sum = one.data + two.data + cy;
	    	 }	 
